...
for i = 1:length(trial_dirs)
    ...
    if save_bool
        ...
        verbose_saveas(fig_shape_3d, d + fileout_base + "3d-positions.fig");
        
        %- 2-D plot
        verbose_savefig(fig_shape_2d, d + fileout_base + "2d-positions.fig");
        verbose_saveas(fig_shape_2d, d + fileout_base + "2d-positions.fig");
        
        %- error plot
        verbose_savefig(fig_err, d + fileout_base + "3d-positions-errors.fig");
        verbose_saveas(fig_err, d + fileout_base + "3d-positions-errors.fig");
